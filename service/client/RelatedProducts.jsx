    ...
    return (        
            ...
            >
                 ...
                 {props.relatedData.map((e)=>(
                               <div className  ="inline-block px-3  "  key = {e.id} >
                               <div
                              ...
                              >  
             <div> <div  className=" top-0 right-0">
             <StarBorderIcon onClick={() =>props.addoutfit(e)}/>
             </div>
             <img className="rounded" src='https://hatrabbits.com/wp-content/uploads/2017/01/random.jpg' alt="hello" onClick = {()=>clickandle(true)}/> 
